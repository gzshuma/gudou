...
.collectionBar .mask-time { position: absolute; left: 10px; top: 0; font-size: 14px; color: #fff; }
...
.collectionBar .pic-btm { position: relative; height: 35px; line-height: 35px; font-size: 14px; color: #445560; padding: 0 8px; }
